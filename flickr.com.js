    ...
    if(in_detail_view) {
		...
		$("#main").append('<div class="yui3-popover-content-hider" style="left:-999em;"> '+
			'<div id="bulkTip" class="yui3-widget yui3-popover yui3-widget-positioned yui3-widget-stacked" style=" width: 300px; left: 12660px; top: -1220px; z-index: 0; ">'+
				...
				' <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="14" height="14" id="clippy" > ' +
...
'    <embed src="'+service_endpoint+'/clippy.swf" FlashVars="func=_bulk_getLink&label=&feedback="  width="14" height="14" name="clippy" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" bgcolor="#FFFFFF" ' +
'    />' +
